...
class StudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'absent_of_parent_name' => ['nullable', 'max:255'],
            'absent_of_parent_relation' => ['nullable', 'max:255'],
            'absent_of_parent_occupation' => ['nullable', 'max:255'],
            'absent_of_parent_annual_earning' => ['nullable','integer'],
            'previous_scholarship_name_group' => ['nullable', 'max:255'],
        ];
    }
}
