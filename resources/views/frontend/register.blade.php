            ...
            <form action="{{ @$student ? route('students.update', $student->id) : route('students.store') }}"
                    ...
                    <div class="col-md">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="radio" class="form-check-input" name="school_madrasa" id="school"
                                value="school" @if(@$student->school_madrasa == "School") selected @endif
                            ...
                            <input type="radio" class="form-check-input" name="school_madrasa" id="madrasha"
                                value="madrasha" @if(@$student->school_madrasa == "Madrasha") selected @endif {{
                    ...
                    <div class="col-md">
                        <div class="form-group mb-5">
                            <input type="radio" class="form-check-input" name="student_type" id="male" value="male" {{
                                @$student->student_type == "Male" ? 'checked' : '' }} {{ old('student_type') == 'male' ?
                            'checked' : ''}}>
                            <label class="form-check-label" for="male">Male</label>

                            <input type="radio" class="form-check-input" name="student_type" id="female" value="female"
                                {{@$student->student_type == "Female" ? 'checked' : ''}} {{ old('student_type') ==
                            'female' ? 'checked' : ''}}>
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('class_roll') is-invalid @enderror"
                                ...
                                {{old('class_roll')}} placeholder="Roll" />
                            @error('class_roll')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('class_division') is-invalid @enderror"
                                name="{{ 'class_division' }}" id="class_roll" value="{{ @$student->class_division }}"
                                {{old('class_division')}} placeholder="Subject" />
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('class_section') is-invalid @enderror"
                                name="{{ 'class_section' }}" id="class_section" value="{{ @$student->class_section }}"
                                {{ old('class_section')}} placeholder="Section" />
                            @error('class_section')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('father_name_bn') is-invalid @enderror"
                                name="{{ 'father_name_bn' }}" id="father_name_bn" {{ old('father_name_bn')}}
                                value="{{ @$student->father_name_bn }}" placeholder="বাবার নাম" />
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control @error('present_address') is-invalid @enderror"
                        name="{{ 'present_address' }}" id="present_address" value="{{ @$student->present_address }}" {{
                        old('present_address')}} placeholder="House Adress" />
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="number"
                                ...
                                value="{{ @$student->permanent_address_post_office }}" {{
                                old('permanent_address_post_office')}} placeholder="Postal Code" />
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('facebook') is-invalid @enderror"
                                name="{{ 'facebook' }}" id="facebook" value="{{ @$student->facebook }}" {{
                                old('facebook')}} placeholder="Facebook" />
                            @error('facebook')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <input type="text"
                                            ...
                                            value="{{ @$student->absent_of_parent_name }}" {{
                                            old('absent_of_parent_name')}} placeholder="Guardian Name" />
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <input type="text" class="form-control" @error('absent_of_parent_relation')
                                            ...
                                            value="{{ @$student->absent_of_parent_relation }}" {{
                                            old('absent_of_parent_relation')}} placeholder="Relationship to Guardian" />
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <input type="text"
                                            ...
                                            value="{{ @$student->absent_of_parent_occupation }}" {{
                                            old('absent_of_parent_occupation')}} placeholder="Guardian Occupation" />
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        <input type="number"
                                            ...
                                            value="{{ @$student->absent_of_parent_annual_earning }}" {{
                                            old('absent_of_parent_annual_earning')}} placeholder="Guardian Income" />
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text"
                        ...
                        value="{{ @$student->previous_scholarship_name_group }}" {{
                        old('previous_scholarship_name_group')}} placeholder="Scholarship Organization Name" />
