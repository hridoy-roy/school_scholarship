        ...
        <form action="{{ @$student ? route('students.update', $student->id) : route('students.store') }}"
            ...
            <div class="row g-3 mt-5">
                <div class="col-md">
                    ...
                    <div class="form-group mb-5">
                        ...
                        value="school" @if(@$student->school_madrasa == "School") selected @endif {{old('school_madrasa') == 'school' ? 'checked' : ''}}>
                        ...
                        <input type="radio" class="form-check-input" name="school_madrasa" id="madrasha"
                            value="madrasha" @if(@$student->school_madrasa == "Madrasha") selected @endif  {{ old('school_madrasa') == 'madrasha' ? 'checked' : ''}}>
                ...
                <div class="col-md">
                    <div class="form-group mb-5">
                        <input type="radio" class="form-check-input" name="student_type" id="male"
                            value="male"  {{ @$student->student_type == "Male" ? 'checked' : '' }} {{ old('student_type') == 'male' ? 'checked' : ''}}>
                        <label class="form-check-label" for="male">Male</label>

                        <input type="radio" class="form-check-input" name="student_type" id="female"
                            value="female" {{@$student->student_type == "Female" ? 'checked' : ''}}  {{ old('student_type') == 'female' ? 'checked' : ''}}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <input type="date" class="form-control @error('dob') is-invalid @enderror"
                                id="dob" name="{{ 'dob' }}" value="{{ @$student->dob }}" {{ old('dob') }}>
                            @error('dob')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            value="{{ @$student->permanent_address_village }}" {{ old('permanent_address_village')}} placeholder="Village Name" />
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            value="{{ @$student->permanent_address_thana }}" {{ old('permanent_address_thana')}} placeholder="Postal Code" />
            ...
            <div class="form-group mb-5">
                ...
                <input type="text" class="form-control @error('permanent_address') is-invalid @enderror"
                    ...
                    value="{{ @$student->permanent_address }}" {{ old('permanent_address')}} placeholder="House Adress" />
                ...
                <div class="col-md">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('facebook') is-invalid @enderror"
                            name="{{ 'facebook' }}" id="facebook" value="{{ @$student->facebook }}" {{ old('facebook')}}
