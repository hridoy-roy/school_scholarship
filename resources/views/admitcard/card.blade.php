                                ...
                                <fieldset class="group-border">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 space">
                                            <input class="form-control input-sm" disabled="disabled" id="title1"
                                                name="title1" value="A134-MULTAS" type="text">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 space">
                                            <input class="form-control input-sm" disabled="disabled" id="title2"
                                                name="title2" value="A134-MULTAS" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 space">
                                            <input class="form-control input-sm" disabled="disabled" id="title3"
                                                name="title3" value="A134-MULTAS" type="text">
                                        </div>
                                    </div>
