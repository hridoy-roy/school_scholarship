        ...
        <div class="bg-light">
            <div class="row">
                <div class="col-lg-8 col-md-12 p-5 bg-white rounded-3">
                    ...
                    @endif
                    <form class="row mb-3" action="{{ route('students.update',$student->id) }}" class="form"
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="school_madrasa" id="school"
                                    ...
                                    (($student->school_madrasa=="school" ) ? 'checked' : '' ) }}>
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="school_madrasa" id="madrasha"
                                    ...
                                    (($student->school_madrasa=="madrasha" ) ? 'checked' : '' ) }}>
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="student_type" id="male" value="male"
                                    {{ old('student_type')=='male' ? 'checked' : (($student->student_type=="male" )
                                ? 'checked' : '' ) }}>
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="student_type" id="female"
                                    ...
                                    (($student->student_type=="female" ) ? 'checked' : '' ) }}>
                        ...
                        <div class="col-md-6 p-3">
                            <label for="name_en" class="form-label"><strong>Name
                                    <code>*(English)</code></strong></label>
                            <input type="text" class="form-control @error('name_en') is-invalid @enderror"
                                name="{{ 'name_en' }}" id="name_en" value="{{ old('name_en') ?? $student->name_en }}"
                                placeholder="Name" />
                            @error('name_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <input type="text" class="form-control @error('name_bn') is-invalid @enderror"
                                name="{{ 'name_bn' }}" id="name_bn" value="{{ old('name_bn') ?? $student->name_bn}}"
                                placeholder="নাম" />
                            @error('name_bn')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <select class="form-select @error('area_id') is-invalid @enderror" required name="area_id"
                                id="institute_id">
                                <option>Select Your Area Name</option>
                                @foreach($areas as $area)
                                <option value="{{$area->id}}" {{($student->area_id == $area->id ) ? 'selected' :
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <select class="form-select @error('institute_id') is-invalid @enderror" required
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <select class="form-select @error('student_class_id') is-invalid @enderror" required
                                name="student_class_id" id="student_class_id">
                                <option>Select Class Name</option>
                                @foreach($student_classes as $student_class)
                                <option value="{{$student_class->id}}" {{(old('student_class_id')==$student_class->id) ?
                                    'selected' : (($student->student_class_id == $student_class->id ) ? 'selected' :
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <input type="number" class="form-control @error('class_roll') is-invalid @enderror"
                                ...
                                value="{{  old('class_roll') ?? $student->class_roll }}" placeholder="Roll" />
                            @error('class_roll')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <select class="form-select" name="class_division" id="class_division">
                                ...
                                <option value="Science" {{ old('class_division')==='Science' ? 'selected' : (($student->
                                    class_division==='Science' ) ? 'selected' : '' ) }}>Science
                                </option>
                                <option value="Commerce" {{ old('class_division')==='Commerce' ? 'selected' :
                                    (($student->class_division==='Commerce' ) ? 'selected' : '' ) }}>Commerce
                                </option>
                                <option value="Arts" {{ old('class_division')==='Arts' ? 'selected' : (($student->
                                    class_division==='Arts' ) ? 'selected' : '' ) }}>Arts
                                </option>
                                <option value="Others" {{ old('class_division')==='Others' ? 'selected' : (($student->
                                    class_division==='Others' ) ? 'selected' : '' ) }}>Others
                                </option>
                            </select>
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <input type="text" class="form-control @error('class_section') is-invalid @enderror"
                                ...
                                value="{{ old('class_section') ?? $student->class_section}}" placeholder="Section" />
                            @error('class_section')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <div class="form-floating input-group mb-4">
                                <input type="text" id="datepicker2"
                                    class="datepicker_input form-control  @error('dob') is-invalid @enderror"
                        ...
                        {{-- ----------- Blood Group ----------- --}}
                        <div class="col-md-6 p-3">
                            <label for="blood_group" class="form-label"><strong>Blood Group <code>*</code>
                                </strong></label>
                            <select class="form-select" name="blood_group" id="blood_group">
                                <option>Select Your Blood Group</option>
                                <option value="A+" {{ old('blood_group')==='A+' ? 'selected' : (($student->
                                    blood_group==='A+' ) ? 'selected' : '' ) }}>A+
                                </option>
                                <option value="B+" {{ old('blood_group')==='B+' ? 'selected' : (($student->
                                    blood_group==='B+' ) ? 'selected' : '' ) }}>B+
                                </option>
                                <option value="O+" {{ old('blood_group')==='O+' ? 'selected' : (($student->
                                    blood_group==='O+' ) ? 'selected' : '' ) }}>O+
                                </option>
                                <option value="AB+" {{ old('blood_group')==='AB+' ? 'selected' : (($student->
                                    blood_group==='AB+' ) ? 'selected' : '' ) }}>AB+
                                </option>
                                <option value="A-" {{ old('blood_group')==='A-' ? 'selected' : (($student->
                                    blood_group==='A-' ) ? 'selected' : '' ) }}>A-
                                </option>
                        ...
                        {{-- ----------- Father Name (Bangla) ----------- --}}
                        <div class="col-md-6 p-3">
                            <label for="father_name_bn" class="form-label"><strong>Father Name
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                name="{{ 'mobile' }}" id="mobile" value="{{ old('mobile') ?? $student->mobile }}"
                                placeholder="Mobile">
                            @error('mobile')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 p-3">
                            <label for="present_address_district" class="form-label"><strong>District Name
                        ...
                        <div class="col-md-6 p-3">
                            <label for="present_address_village" class="form-label"><strong>Village Name
                                    <code>*</code></strong></label>
                            <input type="text"
                        ...
                        <div class="col-md-6 p-3">
                            <label for="present_address_thana" class="form-label"><strong>Thana
                                    <code>*</code></strong></label>
                            <input type="text" class="form-control @error('present_address_thana') is-invalid @enderror"
                                ...
                                value="{{ old('present_address_thana') ?? $student->present_address_thana}}"
                                placeholder="Thana" />
                        ...
                        <div class="col-md-6 p-3">
                            <label for="present_address_post_office" class="form-label"><strong>Postal
                        ...
                        <div class="col-md">
                            <label for="present_address" class="form-label"><strong>House
                            ...
                            <textarea type="text" class="form-control @error('present_address') is-invalid @enderror"
                                ...
                                placeholder="House Adress">{{ old('present_address') ?? $student->present_address}}</textarea>
                        ...
                        <div>
                            <input type="checkbox" class="mt-5" @if ($student->check_address) checked @endif
                            name="check_address" id="check_address" /> Same as Present Address
                        </div>

                        <div class="col-md-6 p-3">
                            <label for="permanent_address_district" class="form-label"><strong>District
                                    Name</strong></label>
                            <input type="text"
                        ...
                        <div class="col-md-6 p-3">
                            <label for="permanent_address_village" class="form-label"><strong>Village Name
                                    <code>*</code></strong></label>
                            <input type="text"
                        ...
                        <div class="col-md-6 p-3">
                            <label for="permanent_address_thana" class="form-label"><strong>Thana
                                    <code>*</code></strong></label>
                            <input type="text"
                        ...
                        <div class="col-md">
                            <label for="permanent_address" class="form-label"><strong>House Address
                                    <code>*</code></strong></label>
                            <textarea type="text"
                        ...
                        <h3 class="h3 text-secondary text-center text-decoration-underline">Absence of Guardian
                            Information</h3>
                        <div class="col-md-6 p-3">
                        ...
                        <div class="col-md-6 p-3">
                            ...
                            <input type="text" class="form-control" @error('absent_of_parent_relation') is-invalid
                                @enderror name="{{ 'absent_of_parent_relation' }}" id="absent_of_parent_relation"
                        ...
                        <div class="col-md-12 p-3">
                            <label for="previous_scholarship_name_group" class="form-label"><strong>Previous Scholarship
                                    Organization (if any) </strong></label>
                            <input type="text"
                                ...
                                <ul class="m-0 p-0">
                                    ...
                                    <li class="d-flex justify-content-start align-items-center mb-2">
                                        <span class="opacity-50 d-flex align-items-center me-3 fs-2">
                                            <img src="{{asset('upload/member/'.$member->banner)}}" alt="" height="50"
                        ...
                        <div class="mb-3">
                            ...
                            <p class="opacity-50 text-justify" style="text-align: justify;">
                                <small class="text-justify">
                                    ...
                                    assumenda aut beatae consectetur cupiditate, deserunt ducimus et eveniet facilis
                                    ipsa, iure minus molestias odit officiis pariatur quae repellendus sed tempore velit
                                    veniam voluptate voluptatibus? Adipisci aliquid architecto assumenda dolorum eos
                                    expedita fugit in ipsa itaque magnam minima modi nam nisi numquam odit ratione
                                    reiciendis tempore, temporibus totam vitae voluptates voluptatibus voluptatum?
                                    Accusamus
                                </small>
                            </p>
                        </div>
