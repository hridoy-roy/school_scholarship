...
<div class="faq-header d-flex flex-column justify-content-center align-items-center rounded">
    ...
    <div class="center">
        <img src="{{ asset('upload/member/'.$member->banner) }}" alt="Banner" height="100" class="center">
    </div>
    <p class="text-center mb-0 px-3">Time : {{ \Carbon\Carbon::parse($member->created_at)->diffForHumans() }}</p>
</div>
